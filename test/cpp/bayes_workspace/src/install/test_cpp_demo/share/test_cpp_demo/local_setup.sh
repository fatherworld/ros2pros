...
: ${AMENT_CURRENT_PREFIX:="/home/bayes/hssw/others/ros2project/test/cpp/bayes_workspace/src/install/test_cpp_demo"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/test_cpp_demo/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/test_cpp_demo/environment/path.sh"
